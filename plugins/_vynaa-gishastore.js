...
. . ╭ Note :
Fitur menu ini dibuat khusus dan hanya untuk *Gisha Store* saja!
%readmore
...
'gisha3': 'Payment :',
 ...
 conn.sendMessage(m.chat, {
      ...
      contextInfo: {
      externalAdReply: {
      title: '© UreshiiBotz | Gisha Store',
      body: '© UreshiiBotz | Gisha Store',
      thumbnailUrl: 'https://telegra.ph/file/72732b6c72cd324bec6da.jpg',
      sourceUrl: 'https://chat.whatsapp.com/BFIpMCYoIkiKt4AXqDPjWg',
      mediaType: 1,
...
handler.tags = ['hannmenu']
handler.command = /^(list-store|gisha-store-list|\?)$/i
