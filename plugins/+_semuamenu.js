...
`.trimStart(),
  ...
  footer: '· · ·',
  after: `© *Hak cipta UreshiiBotz di lindungi undang-undang*`,
}
  try {
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'UreshiiBotz', body: wm, sourceUrl: sgc, thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
