let handler = async (m, { conn, isAdmin, isOwner, args, usedPrefix, command }) => {
  ...
  if (isClose === undefined) {
	  let caption = `
☁️ ${usedPrefix + command} tutup
☁️ ${usedPrefix + command} buka

*-* Contoh: *${usedPrefix + command} tutup 1* 
*-*️ Maka grup akan di buka otomatis 1 jam kemudian.
`
      m.reply(caption)
	  throw false
  }
...
handler.help = ['grouptime <open/close> <jam>']
handler.tags = ['group']
