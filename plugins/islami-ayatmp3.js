...
let handler = async (m, { args, usedPrefix, command }) => {
    if (!(args[0] || args[1])) throw `Format salah, masukan nomor urutan surat dan nomor ayat\n\nContoh: ${usedPrefix + command} 1 2\nMaka Hasilnya Adalah Surah Al-Fatihah Ayat 2 Beserta Audionya`
    if (isNaN(args[0]) || isNaN(args[1])) throw  `Format salah, masukan nomor urutan surat dan nomor ayat\n\nContoh: ${usedPrefix + command} 1 2\nMaka Hasilnya Adalah Surah Al-Fatihah Ayat 2 Beserta Audionya`
